                      ...
                      <div class="row align-items-center">
                          <div class="col-lg-6 col-md-6">
                              <div class="switcher">
                                  <ul>
                                      <li>
                                          <h4>Dễ dàng đổi trả khi mua hàng</h4>
                                      </li>
                                  </ul>
                              </div>
                          </div>
                              ...
                              <div class="header_links">
                                  <ul>
                                         ...
                                         <!-- Nếu chưa đăng nhập -->
                                          ...
                                          <li><a href="{{ route('login-user')}}" title="Đăng nhập">
                                          ...
                                          @if(isset(Auth::user()->name))
                                          <li><a href="" title="{{Auth::user()->name}} ">
                                             <h5>{{Auth::user()->name}} </h5>
                                            </a></li>
                                            <li><a href="{{ route('signout')}}" title="Đăng xuất">
                  ...
                  <div class="header_middel">
                      <div class="row align-items-center">
                          ...
                          <div class="col-lg-3 col-md-3">
                              <div class="logo">
                              <img src="{{asset('logo/logo09.png')}}" alt="">
                                  </a>
                              </div>
                          </div>
                          <!--logo end-->
